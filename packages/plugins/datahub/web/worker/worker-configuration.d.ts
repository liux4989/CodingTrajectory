/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../wrangler.gateway.jsonc worker/worker-configuration.d.ts` (hash: 2e662a6d7c0709027a4ad30baaa9c842)
// Runtime types generated with workerd@1.20260907.1 2026-09-09 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	CT_SUPABASE_URL: string;
	CT_SUPABASE_ANON_KEY: string;
	CF_ACCESS_TEAM_DOMAIN: string;
	CF_ACCESS_AUD: string;
	DATAHUB_FACADE: Fetcher /* coding-trajectory-datahub-facade-preview */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CT_SUPABASE_URL" | "CT_SUPABASE_ANON_KEY" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD">> {}
}
