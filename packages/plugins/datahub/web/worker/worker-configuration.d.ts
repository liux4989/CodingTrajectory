/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../wrangler.live.jsonc worker/worker-configuration.d.ts` (hash: 96afcc9341dc264b393702fdab6d6436)
// Runtime types generated with workerd@1.20260907.1 2026-09-10 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	WORKER_VERSION: WorkerVersionMetadata;
	ASSETS: Fetcher;
	CF_ACCESS_TEAM_DOMAIN: string;
	CF_ACCESS_AUD: string;
	CT_WORKSPACE_ID: string;
	CT_CORE_READ_TOKEN: string;
	CORE: Fetcher /* coding-trajectory-control-plane-staging */ | Fetcher /* coding-trajectory-control-plane */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./live");
	}
	interface StagingEnv {
		...
		CT_WORKSPACE_ID: string;
		CT_CORE_READ_TOKEN: string;
		CORE: Fetcher /* coding-trajectory-control-plane-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "CT_WORKSPACE_ID" | "CT_CORE_READ_TOKEN">> {}
}
