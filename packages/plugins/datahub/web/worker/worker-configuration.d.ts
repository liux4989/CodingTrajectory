/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../wrangler.snapshot.jsonc worker/worker-configuration.d.ts` (hash: beaaa13f28324460226e9ca1f50511e7)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./snapshot");
	}
