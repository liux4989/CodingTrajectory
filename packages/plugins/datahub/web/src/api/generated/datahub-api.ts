...
export type AuthorityObservedAt = string;
export type Coverage = "complete" | "partial" | "unknown";
export type Kind = "project";
export type ModifiedAt = string | null;
export type Name = string;
export type ProjectId = string;
export type Vendors = string[];
export type ArtifactId = string;
export type Coverage1 = "complete" | "projection_unavailable";
export type Kind1 = "session";
...
export type Vendors1 = string[];
export type Warnings = string[] | null;
export type Revision = number;
export type ArtifactId1 = string;
export type Deleted = boolean;
export type Kind2 = "change";
export type Revision1 = number;
export type Coverage2 = "complete" | "not_found" | "projection_unavailable" | "budget_exceeded";
export type Kind3 = "resource";
...
export type ResourceKind = "graph" | "tree" | "item";
export type Items = (CatalogProject | CatalogSession | CatalogChange | CatalogResource)[];
export type LastPublicationAt = string | null;
export type MinimumAvailableRevision = number;
export type MinimumProjectMetadataRevision = number;
export type NextCursor = string | null;
export type ResetRequired = boolean;
export type SchemaVersion = "ct.catalog.v2";
export type AuthorityIncarnation = string;
export type EvaluatedAt = string;
export type ExpiresAt = string;
export type ProjectMetadataRevision = number;
export type PublicationRevision = number;
export type Token = string;
export type WorkspaceSequence = number | null;
...
export type RootSessionId2 = string | null;
...
export type Items1 = EstimateForecastRecord[];
...
export type AuthorityIncarnation2 = string | null;
export type Coverage3 = {
  [k: string]: unknown;
} | null;
...
export type HorizonDays = number | null;
export type MinimumAvailableRevision1 = number;
export type ProjectMetadataRevision2 = number | null;
...
export type Project2 = string | null;
...
export type Warnings3 = ModelUsageWarning[];
...
export type Project4 = string | null;
...
export type Vendors6 = string[];
export type Items2 = ProjectItem[];
...
export type RootSessionId4 = string | null;
...
export type Kind4 = "user" | "assistant" | "tool" | "subagent" | "compaction";
...
export type Vendors7 = string[] | null;
export type GraphId1 = string;
...
export type Vendors8 = string[] | null;
...
export type RootSessionId8 = string | null;
...
export type GraphId2 = string | null;
...
export type Project7 = string | null;
export type RootSessionId9 = string;
export type SessionIds1 = string[];
...
export type Vendors9 = string[];
export type Items3 = SessionItem[];
...
export type RootSessionId10 = string;
...
export type Warnings9 = WarningSummary[];
...
export type Kind7 = "exclusive" | "indicator";
...
export interface DatahubApiContracts {
  CatalogReadResponse?: CatalogReadResponse;
...
/**
 * This interface was referenced by `DatahubApiContracts`'s JSON-Schema
 * via the `definition` "CatalogReadResponse".
 */
export interface CatalogReadResponse {
  ...
  minimum_project_metadata_revision: MinimumProjectMetadataRevision;
...
/**
 * This interface was referenced by `DatahubApiContracts`'s JSON-Schema
 * via the `definition` "CatalogProject".
 */
...
/**
 * This interface was referenced by `DatahubApiContracts`'s JSON-Schema
 * via the `definition` "CatalogSession".
 */
export interface CatalogSession {
  ...
  projection: SessionGraphSummary | null;
  revision: Revision;
}
/**
 * This interface was referenced by `DatahubApiContracts`'s JSON-Schema
 * via the `definition` "SessionGraphSummary".
 */
...
/**
 * This interface was referenced by `DatahubApiContracts`'s JSON-Schema
 * via the `definition` "CatalogChange".
 */
...
/**
 * This interface was referenced by `DatahubApiContracts`'s JSON-Schema
 * via the `definition` "CatalogResource".
 */
...
/**
 * This interface was referenced by `DatahubApiContracts`'s JSON-Schema
 * via the `definition` "CatalogSelection".
 */
export interface CatalogSelection {
  authority_incarnation: AuthorityIncarnation;
  evaluated_at: EvaluatedAt;
  expires_at: ExpiresAt;
  project_metadata_revision: ProjectMetadataRevision;
...
export interface DatahubChanges {
  authority_incarnation?: AuthorityIncarnation1;
  catching_up: CatchingUp;
  deletions: Deletions;
  freshness: DatahubFreshness;
  from_revision: FromRevision;
  invalidations: Invalidations;
  project_metadata_revision?: ProjectMetadataRevision1;
  reset_required: ResetRequired1;
...
export interface DatahubFreshness {
  authority_observed_at?: AuthorityObservedAt1;
  lag_seconds: LagSeconds;
  last_publication_at?: LastPublicationAt1;
...
export interface DatahubSnapshot {
  authority_incarnation?: AuthorityIncarnation2;
  bootstrap: BootstrapStatus;
  catching_up: CatchingUp1;
  freshness: DatahubFreshness;
  generated_at: GeneratedAt1;
  horizon_days: HorizonDays;
  minimum_available_revision: MinimumAvailableRevision1;
  project_metadata_revision?: ProjectMetadataRevision2;
  revision: Revision4;
  source_status: DatahubSourceStatus;
  transport?: ApiTransportMetadata | null;
}
...
export interface SessionTreePayload {
  branches: Branches1;
  root_session_id: RootSessionId10;
