  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[8rem] overflow-hidden rounded-md border border-border-soft bg-popover p-1 text-popover-foreground shadow-popover",
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "focus:bg-surface-emphasis focus:text-foreground",
