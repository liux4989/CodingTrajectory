...
const FALLBACK_PALETTE = ["#0d5c63", "#6d28d9", "#b45309", "#be185d", "#0e7490", "#4d7c0f", "#c2410c", "#7e22ce"];
...
function readApexTheme(): ApexTheme {
  ...
  return {
    ...
    primary: pickVar(style, "--primary", "#0d5c63"),
    ember: pickVar(style, "--ember", "#b9472b"),
...
/** Add an alpha channel (0-1) to a resolved hex or rgb() color. */
