...
coding-trajectory turn list --session-id c4ef6899-8915-4654-98ec-cd96fdc98969 --view pretty
...
- `summary`: compact JSON for humans and lightweight scripting; for
  `session get`, this includes a concise ordered timeline of standalone
  session events and turn sections, with only the necessary nested fields
